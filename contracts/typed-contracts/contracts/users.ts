...
import { ContractAbi } from '../contract-info/users';
import QueryMethods from '../query/users';
import BuildExtrinsicMethods from '../build-extrinsic/users';
import TxSignAndSendMethods from '../tx-sign-and-send/users';
import MixedMethods from '../mixed-methods/users';
import EventsClass from '../events/users';
