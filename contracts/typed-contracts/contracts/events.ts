...
import { ContractAbi } from '../contract-info/events';
import QueryMethods from '../query/events';
import BuildExtrinsicMethods from '../build-extrinsic/events';
import TxSignAndSendMethods from '../tx-sign-and-send/events';
import MixedMethods from '../mixed-methods/events';
